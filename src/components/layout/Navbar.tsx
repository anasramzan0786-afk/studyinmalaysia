        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#0a2540] hover:bg-[#153454] text-white text-xs lg:text-sm font-semibold px-4 py-2.5 rounded-xl shadow-sm hover:shadow-md transition-all active:scale-95"
            >
        ...
        <div className="md:hidden border-t border-slate-200 bg-white px-4 pt-3 pb-6 space-y-2 animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="pt-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-[#0a2540] text-white py-3 rounded-xl font-semibold text-sm shadow-sm"
            >
              <PhoneCall className="w-4 h-4 text-emerald-400" />
